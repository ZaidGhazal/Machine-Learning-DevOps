...
def test_class_names(data):
    ...
    assert (data["genre"].isin(known_classes)).all(), "Unknown class names found in data"
...
def test_column_ranges(data):
    ...
    for col_name, (minimum, maximum) in ranges.items():
        ...
        # test
        assert (data["col_name"].between(minimum, maximum)).all() , f"Column {col_name} failed test {minimum} and {maximum}"
